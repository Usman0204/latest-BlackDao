export const THE_GRAPH_URL = "https://api.studio.thegraph.com/query/19881/black-dao-graph/v0.0.14";
...
export const POOL_GRAPH_URLS: IPoolGraphURLS = {
  4: "https://api.studio.thegraph.com/query/19881/black-dao-graph/v0.0.14",
  1: "https://api.studio.thegraph.com/query/19881/black-dao-graph/v0.0.14",
};
